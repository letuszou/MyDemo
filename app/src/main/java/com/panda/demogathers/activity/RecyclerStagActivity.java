...
public class RecyclerStagActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_stag);
        initData();
    ...
    private void initView() {
        mRecyclerView = (RecyclerView) findViewById(R.id.rv_view_stag);
...
//        LinearLayoutManager 现行管理器，支持横向、纵向。
        ...
        recyclerAdapter.setOnItemClickLitener(new RecyclerStagAdapter.OnItemClickLitener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(RecyclerStagActivity.this,"短点击了"+position+"是"+myData.get(position),Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onItemLongClick(View view, int position) {
                Toast.makeText(RecyclerStagActivity.this,"长点击了"+"是"+myData.get(position)+position,Toast.LENGTH_SHORT).show();
            }
        });
