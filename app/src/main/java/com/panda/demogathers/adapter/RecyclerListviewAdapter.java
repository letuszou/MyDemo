...
public class RecyclerListviewAdapter extends RecyclerView.Adapter<RecyclerListviewAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        MyViewHolder myViewHolder = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_recycler_listview, viewGroup,false));
        return myViewHolder;
    }
